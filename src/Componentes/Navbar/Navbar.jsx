...
export function Navbar() {
  ...
  return (
    <nav id="header" className="w-full z-30 top-10 py-1 shadow-lg border-slate-500 bg-[#5974A9] h-[80px] font-comfortaa text-[14px]  ">
      ...
      <div className="group md:hidden block">
         ...
         <div className="order-2 md:order-3 flex flex-wrap items-center justify-end mr-0 md:mr-4" id="nav-content">
            <div className="auth flex items-center w-full md:w-full">
               <Link to={LOGIN_URL} className="bg-white text-gray-800  p-2 rounded-[6px] border border-gray-300 mr-8 hover:bg-gray-100 hover:text-gray-700 font-bold">Iniciar sesión</Link>
