...
export function Telefono() {
  return (
    <select id="phone" name="phone" value="hola">
    <option>phone</option>
    ...
    <option value="242">República Democrática del Congo +242</option>
    ...
    <option value="500">Islas Malvinas (Islas Falkland) +500</option>
    ...
    <option value="44">Guernesey +44</option>
    ...
    <option value="64">Islas Pitcairn +64</option>
    ...
    <option value="500">Islas Georgia del Sur y Sandwich del Sur +500</option>
    ...
    <option value="1">Islas menores alejadas de EE. UU. +1</option>
