...
const handleOnChange = (event)=>{
    ...
    <div className="max-w-lg mx-auto m-16 bg-white p-10 rounded-xl shadow shadow-slate-300 h-9/10">
        ...
        <div className="my-5">
            <button onClick={handleSigninWithGoogle} className="w-full text-center py-3 my-3 border flex space-x-2 items-center justify-center border-slate-200 rounded-lg text-slate-900 hover:border-slate-400 hover:text-slate-900 hover:shadow transition duration-150">
        ...
        <form action="" onSubmit={onSubmit} className="my-10">
            <div className="flex flex-col space-y-5">
                ...
                <div className="flex flex-row justify-between">
                    <div>
                        <label htmlFor="remember" className="">
                            <input type="checkbox" id="remember" className="w-4 h-4 border-slate-200 focus:bg-indigo-600 m-2"/>
                            Recuérdame
                        </label>
                    </div>
                    <div>
                        <a href="#" className="font-medium text-indigo-600">¿Has olvidado tu contraseña?</a>
                    </div>
                </div>
                ...
                <p className="text-center">¿Aún no tienes una cuenta? <Link to={REGISTER_URL} className="text-indigo-600 font-medium inline-flex space-x-1 items-center underline"><span>¡Regístrate ahora! </span><span><svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2">
