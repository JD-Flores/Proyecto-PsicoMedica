    ...
    <div id='contenedor' className="flex h-screen justify-center items-center">
        <div id="ladoizq" className="w-full h-full text-center">
          ...
          <div id="footer" className="h-1/5 flex justify-center items-end p-6">
             <p className="text-center text-white font-medium">¿Ya tienes una cuenta? <Link to={LOGIN_URL} className="text-black font-medium inline-flex space-x-1 items-center underline"><span>Inicia sesión. </span><span><svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2">
